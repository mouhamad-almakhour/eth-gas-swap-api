...
export class GasPriceController {
    ...
    @ApiOperation({ summary: 'Get current Ethereum gas prices (all values (except formatted) in Gwei)' })
    @Get('gasPrice')
            ...
            throw new HttpException(
                {
                    ...
                    message: 'Gas price service is initializing. Please try again shortly.',
