...
describe('UniswapController', () => {
    ...
    const mockResponse: UniswapResponseDto = {
        ...
        reserves: { reserve0: '1000000000000000000', reserve1: '2000000000000000000' },
    };
    ...
    it('should throw BadRequestException if service throws', async () => {
        (service.getReturn as jest.Mock).mockRejectedValue(new Error('Invalid input'));
        ...
        await expect(controller.getReturn(dto)).rejects.toThrow(BadRequestException);
    });
});
